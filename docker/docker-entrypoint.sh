...
BEDROCK_AWS_REGION=${BEDROCK_AWS_REGION:-us-west-2}
...
export USE_GEMINI=${USE_GEMINI:-false}  # Legacy support

# Claude Bedrock
export BEDROCK_AWS_ACCESS_KEY_ID=${BEDROCK_AWS_ACCESS_KEY_ID}
export BEDROCK_AWS_SECRET_ACCESS_KEY=${BEDROCK_AWS_SECRET_ACCESS_KEY}
...
# Project AWS (different from Bedrock)
