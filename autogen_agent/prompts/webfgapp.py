def WEBFG_APP_PROMPT ():   
  webfg_app_prompt =  f"""
    ...
    3. Add all code changes you have made to your feature branch using `git add` command
    4. Then commit all code changes you have added using `git commit` providing a descriptive commit message of what the changes include
    5. Push your commit using `git push`, confirm that it was pushed successfully
    4. Then tell the user that the task is complete, and that you added, committed, and pushed the changes successfully. Please provide a link to your PR so that the user can review your code changes
