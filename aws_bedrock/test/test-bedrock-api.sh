...
aws bedrock list-foundation-models --query "modelSummaries[?modelId=='anthropic.claude-3-haiku-20240307-v1:0' || modelId=='anthropic.claude-3-5-sonnet-20240620-v1:0'].modelId" --output text
